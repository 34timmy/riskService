...
-- ALTER TABLE company_business_params ADD CONSTRAINT company_fk FOREIGN KEY (company_id) REFERENCES company (id) ON DELETE CASCADE;
-- ALTER TABLE company_business_params ADD CONSTRAINT param_fk FOREIGN KEY (param_code) REFERENCES business_param (param_code) ON DELETE CASCADE;
...
ALTER TABLE model_calc
  ADD CONSTRAINT model_calc_model_fk FOREIGN KEY (model_id) REFERENCES model (id) ON DELETE CASCADE;
ALTER TABLE model_calc
...
-- ALTER TABLE formula ADD CONSTRAINT node_fk FOREIGN KEY (node) REFERENCES model_calc (node) ON DELETE CASCADE;
...
ALTER TABLE formula_params
  ADD CONSTRAINT formula_params_formula_fk FOREIGN KEY (node) REFERENCES formula (id) ON DELETE CASCADE;
-- ALTER TABLE formula_params ADD CONSTRAINT formula_params_bus_param_fk FOREIGN KEY (param_code) REFERENCES business_param (param_code) ON DELETE CASCADE;
...
ALTER TABLE result_data_mapper
  ADD CONSTRAINT res_data_mapper_model_fk FOREIGN KEY (model_id) REFERENCES model (id) ON DELETE CASCADE;
ALTER TABLE result_data_mapper
  ADD CONSTRAINT company_list_fk FOREIGN KEY (company_list_id)
REFERENCES company_list (id) ON DELETE CASCADE;
ALTER TABLE result_data_mapper
